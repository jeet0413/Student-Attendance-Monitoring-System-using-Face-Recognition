...
class Student_Details:
    def __init__(self,root):
        ...
        left_img=left_img.resize((720,145),Image.Resampling.LANCZOS)
        ...
        img_right=img_right.resize((720,200), Image.Resampling.LANCZOS)
...
if __name__ == "__main__":
    print("Starting Student Details Application...")
    root = Tk()
