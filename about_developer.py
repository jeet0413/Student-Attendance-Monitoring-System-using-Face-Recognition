...
class About_Developer:
    def __init__(self,root):
        ...
        img_1=img_1.resize((800,200),Image.Resampling.LANCZOS)
        ...
        img_2=img_2.resize((800,200),Image.Resampling.LANCZOS)
        ...
        img_3=img_3.resize((790,566),Image.Resampling.LANCZOS)
        ...
        dev_lbl=Label(main_frame,text="Hello ! WE ARE FROM RGIT.",font=("times new roman",20,"bold"),bg="light blue",fg="black")
        dev_lbl.place(x=0,y=170,width=730,height=50)

        dev1_lbl=Label(main_frame,text="WE ARE interested in development.",font=("times new roman",20,"bold"),bg="light blue",fg="black")
        dev1_lbl.place(x=0,y=220,width=730,height=50)

        dev1_lbl=Label(main_frame,text="cODING AND FUN.",font=("times new roman",20,"bold"),bg="light blue",fg="black")
