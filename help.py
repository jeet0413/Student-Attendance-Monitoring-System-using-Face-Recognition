...
class Help:
    def __init__(self,root):
        ...
        img_1=img_1.resize((1536,750),Image.Resampling.LANCZOS)
        ...
        dev_lbl=Label(root,text="Email: miniprojectmakers@gmail.com",font=("times new roman",35,"bold"),bg="white",fg="blue")
