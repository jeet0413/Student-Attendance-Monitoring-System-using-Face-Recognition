...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        student_img=student_img.resize((220,220),Image.Resampling.LANCZOS)
        ...
        detectface_img=detectface_img.resize((220,220),Image.Resampling.LANCZOS)
        ...
        att_img=att_img.resize((220,220),Image.Resampling.LANCZOS)
        ...
        about_img=about_img.resize((220,220),Image.Resampling.LANCZOS)
    ...
    def student_details(self):
        print("Opening Student Details Page...")
